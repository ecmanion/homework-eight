var homeContent = `<div class="landing">
...
var aboutContent = `<h1 class="about-title">ABOUT</h1>
...
var locationsContent = `  <h1 class="locations-header">LOCATIONS</h1>
...
var contactContent = `<h1 class="contact">CONTACT US:</h1>
